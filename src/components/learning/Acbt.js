...
class Acbt extends Component {
    render() {
        const data =  [
            {'id':'1','src':'images/ACBT/1.jpg'},
            {'id':'2','src':'images/ACBT/2.jpg'},
            ...
            <section id="resume">
                ...
                <div className="row education">
                    ...
                    <div className="ten columns main-col">
                        {
                            resumeData.leaningAcbt && resumeData.leaningAcbt.map((item)=>{
                                return(
                ...
                <div className="row work">
                    ...
                    <div className="nine columns main-col">
                        {
                            resumeData.leaningAcbtLinks && resumeData.leaningAcbtLinks.map((item) => {
                                return(
                                    <div className="row item">
                                        <div className="twelve columns">
